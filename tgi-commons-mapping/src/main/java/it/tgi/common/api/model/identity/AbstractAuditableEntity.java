package it.tgi.common.api.model.identity;

/**
 * Specialization of {@link it.tgi.common.api.model.AbstractAuditableGenericEntity} for entities using a {@link java.lang.Long} as their primary key
 *
 * @param <U>
