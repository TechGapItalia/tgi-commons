 ...
 * Oracle accepts the type "double precision", but stores it as "float(126)".<br />
 * Whenever hibernate validates such a column, oracle returns "float(126)" and hibernate therefore reports a mismatch.
 * <p />
